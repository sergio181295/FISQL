...
/** SENTENCIAS DDL */
  ...
  static final public void atrTabla(nodoParser p) throws ParseException {
            nodoParser tipo;
  ...
  static final public nodoParser complemento() throws ParseException {
    ...
    if (jj_2_22(2)) {
      jj_consume_token(NULO);
                {if (true) return new nodoParser("complemento",constantes.nulo);}
    } else if (jj_2_23(2)) {
      jj_consume_token(NO_NULO);
                {if (true) return new nodoParser("complemento",constantes.no_nulo);}
    } else if (jj_2_24(2)) {
      jj_consume_token(AUTOINCREMENTABLE);
                {if (true) return new nodoParser("complemento",constantes.autoincrementable);}
    } else if (jj_2_25(2)) {
      jj_consume_token(LLAVE_PRIMARIA);
                {if (true) return new nodoParser("complemento",constantes.llave_primaria);}
    } else if (jj_2_26(2)) {
      ...
      t = jj_consume_token(ID);
                ...
                {if (true) return foranea;}
    } else if (jj_2_27(2)) {
      jj_consume_token(UNICO);
                {if (true) return new nodoParser("complemento",constantes.unico);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  static final public nodoParser eliminar() throws ParseException {
    ...
    eliminarCosa(eliminar);
                {if (true) return eliminar;}
    throw new Error("Missing return statement in function");
  }

  static final public void eliminarCosa(nodoParser p) throws ParseException {
            Token id;
    if (jj_2_33(2)) {
      jj_consume_token(TABLA);
      id = jj_consume_token(ID);
  ...
  static final public nodoParser tipoBackup() throws ParseException {
    if (jj_2_37(2)) {
      jj_consume_token(USQLDUMP);
                {if (true) return new nodoParser(constantes.usqldump, constantes.usqldump);}
    } else if (jj_2_38(2)) {
      jj_consume_token(COMPLETO);
                {if (true) return new nodoParser(constantes.completo, constantes.completo);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  static final public nodoParser tipoOrden() throws ParseException {
    if (jj_2_49(2)) {
      jj_consume_token(ASC);
                    {if (true) return new nodoParser(constantes.asc, constantes.asc);}
    } else if (jj_2_50(2)) {
      jj_consume_token(DESC);
                    {if (true) return new nodoParser(constantes.desc, constantes.desc);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  static final public nodoParser seleccionCampos() throws ParseException {
    ...
    if (jj_2_51(2)) {
      jj_consume_token(ASTERISCO);
                    {if (true) return new nodoParser(constantes.asterisco, constantes.asterisco);}
    } else if (jj_2_52(2)) {
      env = enviados();
                    {if (true) return env;}
    } else {
...
/** SENTENCIAS SSL */
  ...
  static final public nodoParser detener() throws ParseException {
    ...
    jj_consume_token(PUNTOYCOMA);
                    {if (true) return new nodoParser(constantes.detener, constantes.detener);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public nodoParser fecha() throws ParseException {
    ...
    jj_consume_token(PAR2);
    jj_consume_token(PUNTOYCOMA);
                    {if (true) return new nodoParser(constantes.fecha, constantes.fecha);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public nodoParser fechahora() throws ParseException {
    ...
    jj_consume_token(PAR2);
    jj_consume_token(PUNTOYCOMA);
                    {if (true) return new nodoParser(constantes.fecha_hora, constantes.fecha_hora);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public nodoParser tipo() throws ParseException {
    ...
    if (jj_2_74(2)) {
      jj_consume_token(TEXT);
        {if (true) return new nodoParser("tipo",constantes.text);}
    } else if (jj_2_75(2)) {
      jj_consume_token(INTEGER);
        {if (true) return new nodoParser("tipo",constantes.integer);}
    } else if (jj_2_76(2)) {
      jj_consume_token(DOUBLE);
        {if (true) return new nodoParser("tipo",constantes.doublee);}
    } else if (jj_2_77(2)) {
      jj_consume_token(BOOL);
        {if (true) return new nodoParser("tipo",constantes.booll);}
    } else if (jj_2_78(2)) {
      jj_consume_token(DATE);
        {if (true) return new nodoParser("tipo",constantes.datee);}
    } else if (jj_2_79(2)) {
      jj_consume_token(DATETIME);
        {if (true) return new nodoParser("tipo",constantes.datetime);}
    } else if (jj_2_80(2)) {
      t = jj_consume_token(ID);
        {if (true) return new nodoParser("tipo",t.toString().toLowerCase());}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
...
//VARIABLES INICIAN CON @
  ...
  static final public nodoParser valor2() throws ParseException {
    nodoParser val;
    val = valor3();
        nodoParser nuevo = new nodoParser("valor", "valor");
        nuevo.agregarHijo(val);
  ...
  static final public void valor4P(nodoParser p) throws ParseException {
    nodoParser val;
    if (jj_2_86(2)) {
      jj_consume_token(MAYOR);
      val = valor5();
  ...
  static final public void valor5P(nodoParser p) throws ParseException {
    nodoParser val;
    if (jj_2_93(2)) {
  ...
  static final public void valor6P(nodoParser p) throws ParseException {
    nodoParser val;
    if (jj_2_96(2)) {
  ...
  static final public nodoParser valor9() throws ParseException {
    ...
    nodoParser aux;
    if (jj_2_99(2)) {
      val = jj_consume_token(CADENA);
        {if (true) return new nodoParser(constantes.cadena, val.toString().replaceAll("\u005c"", ""));}
    } else if (jj_2_100(2)) {
      val = jj_consume_token(NUMERO);
        {if (true) return new nodoParser(constantes.numero, val.toString());}
    } else if (jj_2_101(2)) {
      jj_consume_token(VERDADERO);
        {if (true) return new nodoParser(constantes.booll, constantes.verdadero);}
    } else if (jj_2_102(2)) {
      jj_consume_token(FALSO);
        {if (true) return new nodoParser(constantes.booll, constantes.falso);}
    } else if (jj_2_103(2)) {
      jj_consume_token(MENOS);
      aux = valor9();
